import {QuestionData} from '002_QuestionInterface'
import {MyDictionary} from "001_DictionaryClass";


export let dictionary = new MyDictionary<string, QuestionData>();

dictionary.setValue('a1', {
    Question: 'Сколько океанов на нашей планете?', Answer: '5', Variant: ['4', '5', '6'], CustomAnswer: -1
});

dictionary.setValue('a2', {
